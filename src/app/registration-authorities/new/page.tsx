...
export default function CreateOrEditRegistrationAuthorityPage() {
  ...
  const awsIntegrationConfig = isEditMode ? raData?.metadata?.[AWS_IOT_METADATA_KEY] : null;
        ...
        <div className="p-6 pt-0"> 
          <Tabs value={activeTab} onValueChange={setActiveTab}>
             <TabsList>
                ...
                {isEditMode && awsIntegrationConfig && (
                    <TabsTrigger value="aws-iot">AWS IoT Integration</TabsTrigger>
                )}
            </TabsList>
            ...
            {isEditMode && raData && awsIntegrationConfig && (
              <TabsContent value="aws-iot" className="mt-4">
                <AwsIotIntegrationTab ra={raData} onUpdate={fetchRaDetails} />
              </TabsContent>
            )}
          </Tabs>
        </div>
